    ...
    return (
        <>
            <div className="flex flex-col justify-center items-center">
                ...
                <div>
                    <button className="my-4" disabled={isLoading ? true : isDisabled} onClick={() => choseFromColorInput("textInput")}>{isLoading ? "...loading" : "Search contrasting colors"}</button>
                    <button disabled={isLoading ? true : isDisabled}
                        onClick={async () => {
                            try {
